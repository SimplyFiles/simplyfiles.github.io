# Privacy policy
Thanks for using SimplyFiles ("application", "service", "we", "us", or "our"). We are commited to protecting your rights to privacy. This privacy policy applies to all our mobile applications and related servies, sales, and marketing.
...
When you connect to a third party service (e.g. OneDrive, FTP server) we share the data with these providers which is required to connect to and use their services.
